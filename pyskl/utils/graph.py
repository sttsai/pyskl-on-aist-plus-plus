...
from tools_st.debug.plot_A_graph import *
...
class Graph:
    ...
    Args:
        ...
        'openpose', 'nturgb+d', 'coco', 'smpl', 'smpl24', 'smpl45'. Default: 'coco'.
    ...
    def __init__(self,
        ...
        assert layout in ['openpose', 'nturgb+d', 'coco', 'handmp', 'smpl', 'smpl24', 'smpl45']
    ...
    def get_layout(self, layout):
        if layout == 'openpose':
            ...
            self.center = 0
        elif layout == 'smpl' or layout == 'smpl24':
            self.num_node = 24
            self.inward = [
                (1, 0), (2, 0), (4, 1), (5, 2), (7, 4), (8, 5), (10, 7), (11, 8), (3, 0), (6, 3), (9, 6),
